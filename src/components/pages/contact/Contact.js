    ...
    <div className="img-form">
      <div className="container container-contact img-forme">
        <div className="contact-info">
          ...
          <hr />
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi doloremque voluptas dignissimos maxime
            suscipit, possimus eum excepturi odio quod, ipsa alias ratione nam perspiciatis adipisci omnis laudantium
